%include "macros.inc"
    ...
    extern  __CEXT_V(p_bpk_corn3b)
    extern  __CEXT_V(p_bpk_corn3a)
    extern  __CEXT_V(p_pal_copper)
    extern  __CEXT_V(p_pal_carcol)
    extern  __CEXT_V(p_bpk_15x150)
    extern  __CEXT_V(p_bpk_f_big3a)
    extern  __CEXT_V(p_bpk_f_sma3b)
    extern  __CEXT_V(p_bpk_f_sma3c)
    extern  __CEXT_V(p_bpk_f_sma3a)
    extern  __CEXT_V(p_bpk_f_med1a)
    extern  __CEXT_V(p_bpk_menubg5)
    extern  __CEXT_V(p_bpk_mulsbg2)
    extern  __CEXT_V(p_bpk_rank1c)
    extern  __CEXT_V(p_bpk_resupok1)
    extern  __CEXT_V(p_bpk_rankinf1)
    extern  __CEXT_V(p_bpk_rankinf2)
    extern  __CEXT_V(p_bpk_rankinf3)
    extern  __CEXT_V(p_bpk_race_eas)
    extern  __CEXT_V(p_bpk_race_med)
    extern  __CEXT_V(p_bpk_race_har)
    extern  __CEXT_V(p_bpk_p_name)
    extern  __CEXT_V(p_bpk_p_pist)
    extern  __CEXT_V(p_bpk_p_rank)
    extern  __CEXT_V(p_bpk_pts_easy)
    extern  __CEXT_V(p_bpk_pts_med)
    extern  __CEXT_V(p_bpk_pts_hard)
    extern  __CEXT_V(p_bpk_placing)
    extern  __CEXT_V(p_bpk_carres)
    extern  __CEXT_V(p_bpk_face01)
    extern  __CEXT_V(p_bpk_face02)
    extern  __CEXT_V(p_bpk_face03)
    extern  __CEXT_V(p_bpk_face04)
    extern  __CEXT_V(p_bpk_face05)
    extern  __CEXT_V(p_bpk_face06)
    extern  __CEXT_V(p_bpk_face07)
    extern  __CEXT_V(p_bpk_face08)
    extern  __CEXT_V(p_bpk_face09)
    extern  __CEXT_V(p_bpk_face10)
    extern  __CEXT_V(p_bpk_face11)
    extern  __CEXT_V(p_bpk_face12)
    extern  __CEXT_V(p_bpk_face13)
    extern  __CEXT_V(p_bpk_face14)
    extern  __CEXT_V(p_bpk_face15)
    extern  __CEXT_V(p_bpk_face16)
    extern  __CEXT_V(p_bpk_face17)
    extern  __CEXT_V(p_bpk_face18)
    extern  __CEXT_V(p_bpk_face19)
    extern  __CEXT_V(p_bpk_face20)
    extern  __CEXT_V(pal_bgcop)
    extern  __CEXT_V(bpk_rank1c)
    extern  __CEXT_V(p_pal_bgcop)
    extern  __CEXT_V(p_bpk_facexx)
    extern  __CEXT_V(MENU_BPA)
    extern  __CEXT_V(bpk_15x150)
    extern  __CEXT_V(BPA_Buffer)
    extern  __CEXT_V(bpk_f_big3a)
    extern  __CEXT_V(bpk_f_sma3a)
    extern  __CEXT_V(bpk_f_sma3b)
    extern  __CEXT_V(bpk_f_sma3c)
    extern  __CEXT_V(bpk_f_med1a)
    extern  __CEXT_V(bpk_resupok1)
    extern  __CEXT_V(bpk_mulsbg2)
    extern  __CEXT_V(bpk_rankinf1)
    extern  __CEXT_V(bpk_rankinf2)
    extern  __CEXT_V(bpk_rankinf3)
    extern  __CEXT_V(bpk_race_eas)
    extern  __CEXT_V(bpk_race_med)
    extern  __CEXT_V(bpk_race_har)
    extern  __CEXT_V(bpk_p_name)
    extern  __CEXT_V(bpk_p_pist)
    extern  __CEXT_V(bpk_p_rank)
    extern  __CEXT_V(bpk_pts_easy)
    extern  __CEXT_V(bpk_pts_med)
    extern  __CEXT_V(bpk_pts_hard)
    extern  __CEXT_V(bpk_placing)
    extern  __CEXT_V(bpk_carres)
    extern  __CEXT_V(bpk_face01)
    extern  __CEXT_V(bpk_face02)
    extern  __CEXT_V(bpk_face03)
    extern  __CEXT_V(bpk_face04)
    extern  __CEXT_V(bpk_face05)
    extern  __CEXT_V(bpk_face06)
    extern  __CEXT_V(bpk_face07)
    extern  __CEXT_V(bpk_face08)
    extern  __CEXT_V(bpk_face09)
    extern  __CEXT_V(bpk_face10)
    extern  __CEXT_V(bpk_face11)
    extern  __CEXT_V(bpk_face12)
    extern  __CEXT_V(bpk_face13)
    extern  __CEXT_V(bpk_face14)
    extern  __CEXT_V(bpk_face15)
    extern  __CEXT_V(bpk_face16)
    extern  __CEXT_V(bpk_face17)
    extern  __CEXT_V(bpk_face18)
    extern  __CEXT_V(bpk_face19)
    extern  __CEXT_V(bpk_face20)
    extern  __CEXT_V(bpk_facexx)
    extern  __CEXT_V(pal_copper)
    extern  __CEXT_V(pal_carcol)
    extern  __CEXT_V(bpk_corn3a)
    extern  __CEXT_V(bpk_corn3b)
    extern  __CEXT_V(bpk_menubg5)
...
;; 12200h
__GDECL(__CEXT_F(unloadMenuBPK))
		push    4
		call    __CHK
