...
___69502h:
		...
		mov     al, [esi]
		add     ecx, edx
		;mov     ebx, [eax*4+0c0dec0deh]
		db	8bh,1ch,85h
___69516h:
		db	0deh,0c0h,0deh,0c0h
		adc     esi, ebp
		add     [edi], ebx
		mov     al, [esi]
		add     ecx, edx
