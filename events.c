...
void Scancodes_Init(void){
    ...
    SCANCODE_TABLE[SDL_SCANCODE_1] = 0x02;
    SCANCODE_TABLE[SDL_SCANCODE_2] = 0x03;
    SCANCODE_TABLE[SDL_SCANCODE_3] = 0x04;
    SCANCODE_TABLE[SDL_SCANCODE_4] = 0x05;
    SCANCODE_TABLE[SDL_SCANCODE_5] = 0x06;
    SCANCODE_TABLE[SDL_SCANCODE_6] = 0x07;
    SCANCODE_TABLE[SDL_SCANCODE_7] = 0x08;
    SCANCODE_TABLE[SDL_SCANCODE_8] = 0x09;
    SCANCODE_TABLE[SDL_SCANCODE_9] = 0x0a;
    SCANCODE_TABLE[SDL_SCANCODE_0] = 0x0b;

    SCANCODE_TABLE[SDL_SCANCODE_KP_1] = 0x4f;
    SCANCODE_TABLE[SDL_SCANCODE_KP_2] = 0x50;
    SCANCODE_TABLE[SDL_SCANCODE_KP_3] = 0x51;
    SCANCODE_TABLE[SDL_SCANCODE_KP_4] = 0x4b;
    SCANCODE_TABLE[SDL_SCANCODE_KP_5] = 0x4c;
    SCANCODE_TABLE[SDL_SCANCODE_KP_6] = 0x4d;
    SCANCODE_TABLE[SDL_SCANCODE_KP_7] = 0x47;
    SCANCODE_TABLE[SDL_SCANCODE_KP_8] = 0x48;
    SCANCODE_TABLE[SDL_SCANCODE_KP_9] = 0x49;
    SCANCODE_TABLE[SDL_SCANCODE_KP_0] = 0x52;
