...
static void restore_dummy(dword, dword, dword, dword);
#pragma aux restore_dummy =	\
	parm [eax][edx][ebx][ecx]

void decode__bpa(DUMMY(1), DUMMY(2), DUMMY(3), DUMMY(4),
        void * dst, void * src){
...
//		pop     ebp
//		ret     8
	restore_dummy(dummy1, dummy2, dummy3, dummy4);
