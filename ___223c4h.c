...
void ___223c4h(void){
	...
	while(++n < 0xa){
		...
		___12e78h_cdecl(___1a10b8h, ___185c7ah, esp, 7817+0x3700*(n+6));
		itoa_watcom106(D(___1a0e28h+0x14*n+0xc), esp, 10);

		if(((int)D(___1a0e28h+0x14*n+0xc) >= 0)&&((int)D(___1a0e28h+0x14*n+0xc) < 0xa)){
				
			___12e78h_cdecl(___1a10b8h, ___185c7ah, esp, esi+0x158);
		}

		if(((int)D(___1a0e28h+0x14*n+0xc) >= 0xa)&&((int)D(___1a0e28h+0x14*n+0xc) < 0x64)){

			___12e78h_cdecl(___1a10b8h, ___185c7ah, esp, 8016+0x3700*(n+6));
		}

		if((int)D(___1a0e28h+0x14*n+0xc) >= 0x64){
				
			___12e78h_cdecl(___1a10b8h, ___185c7ah, esp, 8008+0x3700*(n+6));
		}

		strcpy(esp, ___18768ah[D(___1a0e28h+0x14*n+0x10)]);
		___12e78h_cdecl(___1a10b8h, ___185c7ah, strupr_watcom106(esp), 8109+0x3700*(n+6));
	}
