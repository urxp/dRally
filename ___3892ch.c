...
___38c90h:
		L(eax) = B(esi);
		if(L(eax) == 0) goto ___38c98h;
		B(ebx) = L(eax);
___38c98h:
		ebx++;
		esi++;
		edi--;
		if(edi) goto ___38c90h;
		ebx += 0x280;
		ebx -= edx;
		ecx--;
		if(ecx) goto ___38c8eh;
		ecx = 0x182;
		edx = 0x110;
		ebx = D(___1a112ch__VESA101_ACTIVESCREEN_PTR);
		esi = D(___1a0fd8h);
...
___38cc6h:
		L(eax) = B(esi);
		if(L(eax) == 0) goto ___38cceh;
		B(ebx) = L(eax);
___38cceh:
		ebx++;
		esi++;
		edi--;
		if(edi) goto ___38cc6h;
		ebx += 0x280;
		ebx -= edx;
		ecx--;
		if(ecx) goto ___38cc4h;
		eax = 0x14;
		ebp ^= ebp;
		___37ed4h_cdecl(eax);
		eax ^= eax;
