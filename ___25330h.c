...
void ___25330h(void){
	...
	while(++j < 0xe0){
		...
		i = -1;
		while(++i < 0x60) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x13aa0+0x280*j+i) = B(D(___1a1ed4h)+0x60*j+i);
	}
	...
	while(++j < 0x40){
		...
		i = -1;
		while(++i < 0x60) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x162a0+0x280*j+i) = B(___1a0180h+0x1800*D(___1a01e0h+0x1c+0x6c*D(___1a1ef8h))+0x60*j+i);
	}

	strcpy(buff, ___1a01e0h+0x6c*D(___1a1ef8h));
	strupr_watcom106(buff);
	___12e78h_cdecl(D(___1a10b8h), ___185c7ah, buff, ___25230h(buff)+0x13d20);
	...
	___12e78h_cdecl(D(___1a1108h), &___185c0bh, buff, ___250e0h(buff)+0x202a0);
	...
	strcat(buff, buff_tmp);
	___12e78h_cdecl(D(___1a10b8h), ___185c7ah, buff, 0x31fe0);

	itoa_watcom106(D(___1a01e0h+0x48+0x6c*D(___1a1ef8h)), buff_tmp, 0xa);
	strcpy(buff, (strlen(buff_tmp) == 1) ? " #" : "#");
	strcat(buff, buff_tmp);
	___12e78h_cdecl(D(___1a10b8h), ___185c7ah, buff, 0x34560);
		
	n = -1;
	while(++n < 5) memset(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x2fd00+0x280*n+0x224, 0x3f, (44*D(___1a01e0h+0xc+0x6c*D(___1a1ef8h))+99)/100);
	...
	___12e78h_cdecl(D(___1a1108h), &___185c0bh, buff, 0x280*302+623-offset);
	...
	while(++n < ___18e298h[D(___1a01e0h+0x1c+0x6c*D(___1a1ef8h))].n_engine_upgrades){
		...
		while(++j < 0xa){
			...
			i = -1;
			while(++i < 0x14) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x248a3+0x17*n+0x280*j+i) = B(D(___1a1e90h)+0x320+0x14*j+i);
		}
	}
	...
	while(++n < ___18e298h[D(___1a01e0h+0x1c+0x6c*D(___1a1ef8h))].n_tire_upgrades){
		...
		while(++j < 0xa){
			...
			i = -1;
			while(++i < 0x14) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x284a3+0x17*n+0x280*j+i) = B(D(___1a1e90h)+0x320+0x14*j+i);
		}
	}
	...
	while(++n < ___18e298h[D(___1a01e0h+0x1c+0x6c*D(___1a1ef8h))].n_armor_upgrades){
		...
		while(++j < 0xa){
			...
			i = -1;
			while(++i < 0x14) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x2c0a3+0x17*n+0x280*j+i) = B(D(___1a1e90h)+0x320+0x14*j+i);
		}
	}
	...
	while(++n < (int)D(0x6c*D(___1a1ef8h)+___1a01e0h+0x10)){
		...
		while(++j < 0xa){
			...
			i = -1;
			while(++i < 0x14) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x248a3+0x17*n+0x280*j+i) = B(D(___1a1e90h)+0xc8*n+0x14*j+i);
		}
	}
	...
	while(++n < (int)D(0x6c*D(___1a1ef8h)+___1a01e0h+0x14)){
		...
		while(++j < 0xa){
			...
			i = -1;
			while(++i < 0x14) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x284a3+0x17*n+0x280*j+i) = B(D(___1a1e90h)+0xc8*n+0x14*j+i);
		}
	}
	...
	while(++n < (int)D(___1a01e0h+0x18+0x6c*D(___1a1ef8h))){
		...
		while(++j < 0xa){
			...
			i = -1;
			while(++i < 0x14) B(D(___1a112ch__VESA101_ACTIVESCREEN_PTR)+0x2c0a3+0x17*n+0x280*j+i) = B(D(___1a1e90h)+0xc8*n+0x14*j+i);
		}
	}
}
