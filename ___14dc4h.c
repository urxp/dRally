...
void ___14dc4h(void){
	...
	___13094h_cdecl(___1876d2h+0x320*n+0x000, 0x154a1);
	___13094h_cdecl(___1876d2h+0x320*n+0x050, 0x17ca1);
	___13094h_cdecl(___1876d2h+0x320*n+0x0a0, 0x1a4a1);
	___13094h_cdecl(___1876d2h+0x320*n+0x0f0, 0x1cca1);
	___13094h_cdecl(___1876d2h+0x320*n+0x140, 0x1f4a1);
	___13094h_cdecl(___1876d2h+0x320*n+0x190, 0x21ca1);
	___13094h_cdecl(___1876d2h+0x320*n+0x1e0, 0x244a1);
	___13094h_cdecl(___1876d2h+0x320*n+0x230, 0x26ca1);
	___13094h_cdecl(___1876d2h+0x320*n+0x280, 0x294a1);
	___13094h_cdecl(___1876d2h+0x320*n+0x2d0, 0x2bca1);
